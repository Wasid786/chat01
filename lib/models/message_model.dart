import 'package:chat01/models/user_model.dart';
...
List<Message> chats = [
  Message(
    sender: ironMan,
    time: '5:30 PM',
    text: 'Hey dude! Even dead I\'m Iron Man.',
    unread: true,
  ),
  Message(
...
List<Message> messages = [
  Message(
    sender: ironMan,
    time: '5:30 PM',
    text: 'Hey dude! Event dead I\'m Iron Man.',
    unread: true,
  ),
  Message(
    sender: currentUser,
...
List<Message> requests = [
  ...
  Message(
    ...
    time: '1:45 PM',
    text: 'Could you review this document for me?',
    unread: false,
  ),
  // Add more dummy requests here...
];
